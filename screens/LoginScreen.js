...
const styles = StyleSheet.create({
  ...
  logoMini: { width: 56, height: 56, backgroundColor: 'rgba(0,212,255,0.12)', borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginBottom: 16, borderWidth: 1.5, borderColor: 'rgba(0,212,255,0.3)' },
  ...
  label: { color: '#00D4FF', fontSize: 12, fontWeight: '600', marginBottom: 8, marginTop: 18, letterSpacing: 1 },
  input: {
  ...
  passWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0F1E35', borderRadius: 14, borderWidth: 1.5, borderColor: 'rgba(0,212,255,0.15)' },
  ...
  btnSocial: { backgroundColor: 'rgba(255,255,255,0.05)', paddingVertical: 15, borderRadius: 14, alignItems: 'center', borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.08)', marginBottom: 8, flexDirection: 'row', justifyContent: 'center', gap: 8 },
